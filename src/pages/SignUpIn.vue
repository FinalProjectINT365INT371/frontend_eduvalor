        ...
        <div class="container" id="container">
            ...
            <div class="form-container sign-in-container">
                <v-form action="#">
                    ...
                    <span class="pt-12 text-md-body-1">หรือล็อกอินด้วย Social Media </span>
            ...
            <div class="overlay-container">
                <div class="overlay">
                    ...
                    <div class="overlay-panel overlay-right">
                        ...
                        <h1> ใช่รึเปล่า? </h1>
                        <p>มาร่วมเป็นส่วนหนึ่งในแวดวงเหล่านักเรียนรู้ <br /> ด้วยการเป็นสมาชิกกับเราสิ!</p>
                        <button class="ghost" id="signUp" @click="switchMode()">Sign Up</button>
                    </div>
                </div>
            </div>
        </div>
