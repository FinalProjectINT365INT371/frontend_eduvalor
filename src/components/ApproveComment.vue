    ...
    <div>
        ...
        <div class="allComment d-flex flex-column align-center">
            ...
            <div v-for="(approve, index) in approveData" :key="index"
                ...
                <div class="d-flex justify-space-between align-center">
                    ...
                    <div id="approve-stamp" class="d-flex justify-center flex-column ">
                        <img id="approved" src="../assets/icon/commentManage/approved.png">
                        <p style="text-align: end;"> Approved ล่าสุดเมื่อ <br /> {{ approve.UpdateDate }}</p>
                    </div>
                </div>

                <div class="d-flex">
                    <button elevation="0" class="btn-container" color="#AD9F86" @click="editCall(approve)">
                    ...
                    <button elevation="0" class="btn-container" @click="deleteCm(approve)">
        ...
        <section class="row d-flex justify-center">
            ...
            <div class="allComment d-flex flex-column">
                <div v-for="comment in getComment" :key="comment.ContentId"
                    ...
                    <div class="col-9">
                        <div class="d-flex justify-space-between">
                            ...
                            <div class="d-flex justify-end">
                                <div class="d-flex justify-center">
                                    <button elevation="0" class="btn-container" color="#AD9F86"
                        ...
                        <div style="font-family: 'Kanit';" class="d-flex justify-space-between">
                            <h4 style=" font-weight:600; " v-if="comment.Displayname"> ความคิดเห็นจาก {{
                                    comment.Displayname
                            }} </h4>
                            <h4 style=" font-weight:600;" v-if="!comment.Displayname"> ความคิดเห็นจาก User ID: {{
                                    comment.UserId
                            }}
                            </h4>
                    ...
                    <div class="col-9">
                        ...
                        <v-form v-model="valid" @submit.prevent="submit" ref="Commentform">
                            ...
                            <div class="d-flex ">
                                ...
                                <button class="ml-auto d-inline-flex align-center publish-btn" type="button"
                                    @click="submit">
...
export default {
    ...
    methods: {
        ...
        deleteCm: async function (d) {
            ...
            this.contentID = this.params;
            this.commentID = deleteItem._id; // same as approveID
